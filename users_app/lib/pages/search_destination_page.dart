...
class _SearchDestinationPageState extends State<SearchDestinationPage>
{
  ...
  searchLocation(String locationName) async
  {
    ...
    {
      String apiPlacesUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$locationName&key=$googleMapKey";
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        children: [
                          Checkbox(
                            value: isCombustionCar,
                            onChanged: (value) {
                              setState(() {
                                isCombustionCar = value!;
                                if (isCombustionCar) {
                                  isElectricCar = false;
                                }
                              });
